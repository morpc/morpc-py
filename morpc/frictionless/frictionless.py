    ...
    for field in schema.fields:
        ...
        if((fieldType == "int") or (fieldType == "integer")):
            ...
            if(outDF[fieldName].dtype == "bool"):
                ...
                logger.warning("Field {} is string type. Will interpret using truth values specified in schema (or Frictionless defaults). Nulls will be interpreted as {}. To change this, set nullBoolValue.".format(fieldName, nullBoolValue))
