...
test('@@toStringTag', { skip: !hasToStringTag }, function (t) {
	forEach(typedArrayNames, function (typedArray) {
		...
		// Issue URL: https://github.com/morpc/morpc-py/issues/101
		if (typeof global[typedArray] === 'function') {
			// @ts-expect-error TODO: fix
			// Issue URL: https://github.com/morpc/morpc-py/issues/100
			var fakeTypedArray = [];
			// @ts-expect-error TODO: fix
			// Issue URL: https://github.com/morpc/morpc-py/issues/99
			fakeTypedArray[Symbol.toStringTag] = typedArray;
			// @ts-expect-error TODO: fix
			// Issue URL: https://github.com/morpc/morpc-py/issues/98
...
test('Typed Arrays', function (t) {
	forEach(typedArrayNames, function (typedArray) {
		// @ts-expect-error TODO: fix
		// Issue URL: https://github.com/morpc/morpc-py/issues/97
